module Autoparts
  module Packages
    class GoogleAppEngineGo < Package
      ...
      source_url 'https://storage.googleapis.com/appengine-sdks/featured/go_appengine_sdk_linux_amd64-1.9.15.zip'
      source_sha1 '5677d7cc2a060458f5703db336faa220b110a8b6'
      source_filetype 'zip'

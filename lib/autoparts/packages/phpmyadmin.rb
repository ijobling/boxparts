module Autoparts
  module Packages
    class PhpMyAdmin < Package
      ...
      source_url 'http://sourceforge.net/projects/phpmyadmin/files/phpMyAdmin/4.3.10/phpMyAdmin-4.3.10-all-languages.tar.gz'
      ...
      def install
          myadmin_path.mkpath
        Dir.chdir('phpMyAdmin-4.3.10-all-languages') do
